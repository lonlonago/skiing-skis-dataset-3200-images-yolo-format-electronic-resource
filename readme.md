# Skiing (skis) dataset 3200 images YOLO format electronic resource

# Body

Skiing (skis) dataset, 3200 images in YOLO format， clear images, complete annotations, suitable for target detection model training, worry-free, ready to use directly.
